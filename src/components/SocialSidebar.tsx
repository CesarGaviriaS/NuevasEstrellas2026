...
import { Facebook, Instagram, Phone, X as XIcon } from 'lucide-react';
...
export default function SocialSidebar() {
    ...
    return (
        <>
            {/* Trigger Tabs - Floating Phone/Socials Tab */}
            ...
            >
                ...
                <div className="flex flex-col gap-5 sm:gap-6 items-center py-2">
                    ...
                    {/* WhatsApp */}
                    <a href="https://wa.me/573002125586" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-200 text-primary hover:text-green-600">
                        <svg viewBox="0 0 24 24" className="w-8 h-8 sm:w-10 sm:h-10 fill-current">
